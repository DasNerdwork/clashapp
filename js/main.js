...
function sanitize(text){
  ...
  if(text.match(re) && text.length > 6 && text.length < 23){
    postAjax(`${window.location.protocol}//${window.location.hostname}/clashapp/src/functions.php`, { sumname: text }, function(data){
        if(data == "404"){
            window.location.href="https://clashscout.com/404";
        } else if(data.includes("/")) {
          window.location.href="https://clashscout.com/profile/" + data;
        } else {

...
logHandler = handlers.RotatingFileHandler('/var/www/html/wordpress/clashapp/data/logs/patcher.log', maxBytes=10000000, backupCount=2)
...
json_file.close()
folder = "/var/www/html/wordpress/clashapp/data/patch/"
logger.info("Comparing locale with live patch version") # Comparing locale with live patch version
with open('/var/www/html/wordpress/clashapp/data/patch/version.txt', 'r') as v:
    version = v.read()
...
if (version == variables[0]): # If locale version equals live version
    ...
    target_path = '/var/www/html/wordpress/clashapp/data/patch/' + variables[0] + '.tar.gz' # Extractpath
    ...
    tar.extractall(path='/var/www/html/wordpress/clashapp/data/patch/')
    tar.close()
    ...
    with open('/var/www/html/wordpress/clashapp/data/patch/version.txt', 'w') as f:
        f.write(variables[0])
else:

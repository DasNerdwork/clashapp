...
require_once '/hdd1/clashapp/src/csrf.php';

use Security\CSRF;

// CSRF-Validierung für alle schreibenden AJAX-Endpunkte
...
if(isset($_POST['matches'], $_POST['playerName'])){
    ...
    $endofup = "[" . $currentTime->format('d.m.Y H:i:s') . "] [matchDownloader - INFO]: End of update for \"" . $_POST['playerName'] . "\" - (Final Matchcount: ".count(json_decode($_POST['matches'])).", Approximate Logsize: ".formatNumber((filesize($logPath)/1048576), 3)." MB)";

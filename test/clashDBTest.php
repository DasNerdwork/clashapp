...
class ClashDBTest extends TestCase {
    ...
    public static function setUpBeforeClass(): void {
        ...
        self::$testAcc1 = self::$db->create_account('PHPUnitTest', 'EUW', 'phpunittest@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier123');
        self::$testAcc2 = self::$db->create_account('PHPUnitTest2', 'EUW', 'phpunittest1@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier234');
        ...
        self::$db->deactivate_account('PHPUnitTest2', 'phpunittest1@example.com', 'password123');
    }

    public static function tearDownAfterClass(): void {

        // Clean-up and delete Testaccounts
        self::$db->deactivate_account('PHPUnitTest', 'phpunittest@example.com', 'password123');
    ...
    public function testCheckCredentials() {
        ...
        $validCredentials = self::$db->check_credentials('phpunittest@example.com', 'password123');
        ...
        $wrongPassword = self::$db->check_credentials('phpunittest@example.com', 'wrongpassword');
        ...
        $deactivatedAccountForbidden = self::$db->check_credentials('phpunittest1@example.com', 'wrongpassword123');
    ...
    public function testGetCredentials2FA() {
        $validEmail = self::$db->get_credentials_2fa('phpunittest@example.com');
    ...
    public function testAccountExists() {
        $this->assertTrue(self::$db->account_exists('phpunittest@example.com'), 'Existing email should return true');
        $this->assertTrue(self::$db->account_exists('PHPUnitTest'), 'Existing username should return true');
        $this->assertTrue(self::$db->account_exists('phpunittest@example.com', 'PHPUnitTest'), 'Existing mail and username should return true');
    ...
    public function testSetAndGetStayCode() {
        ...
        $setSuccess1 = self::$db->set_stay_code('abcde', 'phpunittest@example.com');
        $this->assertTrue($setSuccess1, 'Setting staycode via existing mail should return true');

        $getSuccess1 = self::$db->get_stay_code('phpunittest@example.com');
    ...
    public function testSetAndGetPremium() {
        ...
        $setPremium2 = self::$db->setPremium(true, 'phpunittest@example.com');
        $this->assertTrue($setPremium2, 'Setting premium via existing mail should return true');

        $getPremium1 = self::$db->getPremium('phpunittest@example.com');
        $this->assertTrue((bool)$getPremium1, 'Retrieved premium via mail should match the one set');
        ...
        $this->assertFalse((bool)$getPremium2, 'Retrieved premium via username should return false');
    ...
    public function testGetDataViaStayCode() {
        $setStaySuccess = self::$db->set_stay_code('lmnop', 'phpunittest@example.com');
        ...
        $setSuccess2 = self::$db->set_stay_code(NULL, 'phpunittest@example.com');
    }
    ...
    public function testAccountManagement() {
        $createdAccount = self::$db->create_account('testuser_create', 'EUW', 'phpunittest_create@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier123');
        ...
        $this->assertEquals('phpunittest_create@example.com', $createdAccount['email'], 'Created account should have correct email');

        $overCreateAccount = self::$db->create_account('testuser_create', 'EUW', 'phpunittest_create@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier123');
    ...
    public function testVerifyAccount() {
        $testCreatedAccount = self::$db->create_account('testuser', 'EUW', 'phpunittestverify@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier123');
        ...
        $this->assertEquals('success', $testSuccessVerify['status'], 'Correctly verifying an account should return success status');
    ...
    public function testAccountStatus() {
        $testAccountForStatus = self::$db->create_account('testuser', 'EUW', 'phpunittest_status@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]), 'verifier123');
    ...
    public function testGetPUUID() {
        $failGetPUUID = self::$db->get_puuid('phpunittest@example.com');
    ...
    public function testResetPW() {
        $checkPasswordBefore = self::$db->check_credentials('phpunittest@example.com', 'password123');
        ...
        $successResetPW = self::$db->reset_password('PHPUnitTest', 'phpunittest@example.com', password_hash('newpass123', PASSWORD_BCRYPT, ['cost' => 11]));
        ...
        $checkPasswordAfter = self::$db->check_credentials('phpunittest@example.com', 'newpass123');
        $this->assertThat($checkPasswordBefore['label'],
            $this->logicalOr(
                $this->stringContains('Deactivated'),
                $this->stringContains('Allowed'),
        ...
        $successResetPWAgain = self::$db->reset_password('PHPUnitTest', 'phpunittest@example.com', password_hash('password123', PASSWORD_BCRYPT, ['cost' => 11]));

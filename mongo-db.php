...
class MongoDBHelper {
    private $host = 'dasnerdwork.net:17171';
    private $username = 'clashapp';
    private $password = '***REMOVED***MO';
    private $auth = '?authMechanism=SCRAM-SHA-1&authSource=clashappdb&tls=true';
    private $tlsPath = 'tlsCAFile=/etc/ssl/mongodb.pem'; 
    private $databaseName = 'clashappdb';
    private $client;
    private $mdb;
